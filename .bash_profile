...
export PATH=${PATH}:/Users/chris.eastwood/projects/android/android-sdk/platform-tools

export SAXON_CP=/usr/local/Cellar/saxon/saxon9he.jar
export SAXON_HOME=/usr/local/Cellar/saxon/
